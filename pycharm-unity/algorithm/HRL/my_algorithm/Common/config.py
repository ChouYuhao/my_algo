...
def get_params():
    ...
    parser.add_argument("--H_mem_size", default=20000, type=int, help="memory size")
    ...
    parser.add_argument("--play_n_episode", default=100, type=int, help="the number of episode to play.")
