...
def get_params():
    ...
    parser.add_argument("--update_freq", default=200, type=int)
    parser.add_argument("--freeze_interval", default=200, type=int)
    parser.add_argument("--conv", default=False, type=bool)
    parser.add_argument("--termination_reg", default=0.01, type=float)

    parser.add_argument("--train_time_scale", default=10, type=int, help="Scale of time to train in Unity.")
    parser.add_argument("--n_observations", default=172, type=int, help="Dims of states in the environment.")
