...
class SACAgent:
    ...
    def save_checkpoint(self, env_name, suffix="", ckpt_path=None):
        ...
        if not os.path.exists('checkpoints/FourRooms'):
            os.makedirs('checkpoints/FourRooms')
        if ckpt_path is None:
            ckpt_path = "checkpoints/FourRooms/DIAYN_checkpoint_{}_{}".format(env_name, suffix)
            print(ckpt_path)
