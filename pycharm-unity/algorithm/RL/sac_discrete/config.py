...
def get_params():
    ...
    parser.add_argument("--n_states", default=75, type=int, help="Dims of states in the doorKey environment.")
    ...
    parser.add_argument("--if_conv", default=False, type=bool, help="")
