...
def LoadDataFromUnityDemo(demo_path):
    ...
    file = open('D:/Desktop/bc/traj/easycar8-2.pkl', 'wb')
...
if __name__ == '__main__':
    path = "D:/app/Unity/workspace/rlenvironments/Assets/Demonstrations/imgcar-2.demo"
    data = LoadDataFromUnityRosCarDemo2(path)
    print("obs: ",data["cams"].shape)
